...
const AnalyzeDeepfakeOutputSchema = z.object({
  ...
  analysis: z.string().describe('A detailed analysis of the video for deepfake elements, explaining the findings.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a world-renowned expert in digital forensics, specializing in the detection of manipulated and AI-generated video. Your task is to analyze the provided video with extreme scrutiny.

Video: {{media url=videoDataUri}}

You must assess two possibilities:
...
-   **Temporal Consistency:** Check for flickering, jitter, or objects that appear/disappear or change form between frames.
...
-   \`analysis\`: A detailed report on your findings, referencing specific points from the checklist. If you detect something, describe the timestamp or visual evidence.
`,
});
